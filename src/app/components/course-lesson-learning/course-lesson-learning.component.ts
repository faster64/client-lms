...
@Component({
  selector: 'app-course-lesson-learning',
  templateUrl: './course-lesson-learning.component.html',
  styleUrls: ['./course-lesson-learning.component.scss']
})
export class CourseLessonLearningComponent extends BaseComponent {

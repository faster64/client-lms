...
@Component({
  selector: 'app-course-lesson-congratulation',
  templateUrl: './course-lesson-congratulation.component.html',
  styleUrls: ['./course-lesson-congratulation.component.scss']
})
export class CourseLessonCongratulationComponent extends BaseComponent {

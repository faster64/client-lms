...
export class CmsAdminComponent extends CmsGridComponent<User> {

  override ngOnInit(): void {
    this.injector.get(PublisherService).updateCmsHeaderLabelEvent.emit('Quản lý tài khoản quản trị và phân quyền');
    super.ngOnInit();
  }
